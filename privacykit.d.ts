...
declare global {
   ...
   *   - `dialog-content`      Override the intro / body text
  ...
  interface HTMLConsentDialogElement extends HTMLElement {
    ...
    noNecessary: boolean | undefined;
    /** Hide the "Preferences" section from the dialog. */
    noPreferences: boolean | undefined;
   ...
   * slot content whenever `data-ck-blocked` is present on the guard.
   *
   * @example
